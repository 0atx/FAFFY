  ...
  <div id="historyDetail">
    <div>
      ...
      <div id="route">
        ...
        <p class="text-h6" style="font-weight: 600">
          <router-link to="/profile/1/history"> History </router-link>
        </p>
                <v-icon color="black" class="mb-3"> mdi-chevron-right </v-icon>
              ...
              <v-list-item-content>
                <div style="height: 80px;display:flex; align-items:center">
                  <v-list-item-avatar
                    ...
                    size="60"
                    color="grey"
                  ><v-img src="@/assets/images/default_profile.png"></v-img></v-list-item-avatar>
                  <div>

                    <!-- 컨설턴트 닉네임 -->
                    <v-list-item-title style="font-weight: 600" class="text-h6 mt-4 mb-2">
                      별명짓기귀찮다
                    </v-list-item-title>

                    <!-- 컨설턴트 팔로잉 / 팔로워 정보 -->
                    <v-list-item-subtitle>
                      <router-link class="ml-1 mr-4" to="/profile/1/following">팔로잉 163</router-link>
                      <router-link class="ml-4" to="/profile/1/follower">팔로워 208</router-link>
                    </v-list-item-subtitle>
                  </div>
                </div>

                <!-- 컨설턴트 한 줄 자기소개 -->
                <v-list-item id="introduce">소개 들어갈 부분입니다. 근데 간단 소개로 넣을지 상세 소개로 넣을지 고민 중 또 넣을거 없나?</v-list-item>
              ...
              <v-list-item-content>
                <div style="display:flex; align-items:center">
                  <div>
                    ...
                    <!-- 방송 제목 -->
                    <v-list-item-title style="font-weight: 600" class="text-h6 mt-6 mb-2">
                      방송 제목 나올 자리
                    </v-list-item-title>
                ...
                <!-- 방송 소개 -->
                <v-list-item id="introduce">방송 소개 들어갈 부분입니다. 근데 뭔가 더 넣고 싶은데 넣을게 없네...?</v-list-item>
