            ...
            <div style="width: 100%; height:360px;">
              <div v-if="isShare" style="display:flex; justify-content:center;" id="mainVideo" class="mb-3">
                <div style="margin: 0 5%;">
                  <user-video id="myWebcam" style=" width: 500px; height: 360px; object-fit: fill;" :stream-manager="publisher" v-on:capture-event="captureSignal"/>
                </div>
                <div v-for="sub in subscribers" :key="sub.stream.connection.connectionId">
                  <user-video id="myWebcam" style="object-fit: fill;" v-if="checkScreen(sub)" :stream-manager="sub" v-on:capture-event="captureSignal"/>
                </div>
              </div>
              <div v-else id="mainVideo" class="mb-3">
                <user-video id="myWebcam" style="width: 500px; height: 360px; object-fit: fill; margin:0 auto;" :stream-manager="publisher" v-on:capture-event="captureSignal"/>
              </div>
            </div>
            <div>
              <v-sheet
              ...
              >
                ...
                >
                  <v-slide-item
                    ...
                    style="margin: 13px;"
                  >
                  <user-video v-if="!checkScreen(sub)" style="width: 331px; height: 260px; object-fit: fill;" :stream-manager="sub" v-on:capture-event="captureSignal"/>
                  </v-slide-item>
                </v-slide-group>
              </v-sheet>
            </div>
            ...
            <div style="width: 100%; height:360px;">
              <div v-if="isShare" style="display:flex; justify-content:center;" id="mainVideo" class="mb-3">
                <div style="margin: 0 5%;" v-for="sub in subscribers" :key="sub.stream.connection.connectionId">
                  <user-video id="myWebcam" v-if="checkHost(sub) && !checkScreen(sub)" style="width: 500px; height: 360px; object-fit: fill;" :stream-manager="sub" v-on:capture-event="captureSignal"/>
                </div>
                <div v-for="sub in subscribers" :key="sub.stream.connection.connectionId">
                  <user-video id="myWebcam" v-if="checkHost(sub) && checkScreen(sub)" style="object-fit: fill;" :stream-manager="sub" v-on:capture-event="captureSignal"/>
                </div>
              </div>
              <div v-else id="mainVideo" class="mb-3">
                <div v-for="sub in subscribers" :key="sub.stream.connection.connectionId">
                  <user-video id="myWebcam" v-if="checkHost(sub) && !checkScreen(sub)" style="width: 500px; height: 360px; object-fit: fill; margin:0 auto;" :stream-manager="sub" v-on:capture-event="captureSignal"/>
                </div>
              </div>
            </div>
            <div>
